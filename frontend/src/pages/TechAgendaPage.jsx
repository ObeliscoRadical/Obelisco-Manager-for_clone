...
import { Calendar, MapPin, Briefcase, Clock, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-5" data-testid="tech-agenda-page">
      ...
      <div className="space-y-2">
        ...
        {appts.map(a => (
          <Card key={a.id} className={`bg-zinc-900 border-zinc-800 ${isToday(a.date) ? 'border-yellow-500/50' : ''}`} data-testid={`tech-appt-${a.id}`}>
